...
def FigA789():
    ...
    for i in range(len(resource_list)):
        ...
        if i==1:
            ...
            plt.plot(nu_array, diff[-1, :], color='k', linewidth=2,
                     marker='D')
            plt.xlabel('$\log_{10}$ switching rate', fontsize=20)
            ...
            plt.plot(nu_array, comp_exc[-1, :], color='k', linewidth=2,
                     marker='D')
            plt.xlabel('$\log_{10}$ switching rate', fontsize=20)
            plt.ylabel('prob.of exclusion of fittest', fontsize=20)
            plt.xticks([-4, -2, 0, 2], fontsize=16)
            ...
            plt.plot(nu_array, one_ext[-1, :]- both_ext[-1, :], color='k', linewidth=2,
                     marker='D')
            plt.xlabel('$\log_{10}$ switching rate', fontsize=20)
